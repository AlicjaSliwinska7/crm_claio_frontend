...
import { emailRenderer, buildingRoomRenderer } from '../../../shared/tables/utils/renderers'
...
export const HEADER_COLS = [
	...
	col('position', 'Stanowisko', { sortable: true, type: 'string', minWidth: 160 }),

	col('phoneInternal', 'Tel. wewn.', { minWidth: 110 }),
	col('phoneExternal', 'Tel. zewn.', { minWidth: 120 }),
